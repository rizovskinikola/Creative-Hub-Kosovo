...
//     "kind": "widget",
//     "url": "https://www.videoask.com/f3a989ht2",
//     "options": {
...
export function careerCall() {
  ...
  (function () {
    ...
    var _removed = false;
    var form_to_submit = document.getElementById('_form_276_');
    ...
    var form_submit = function (e) {
      ...
      if (validate_form()) {
        ...
        document.querySelector('#_form_276_submit').disabled = true;
        var serialized = _form_serialize(document.getElementById('_form_276_')).replace(/%0A/g, '\\n');
