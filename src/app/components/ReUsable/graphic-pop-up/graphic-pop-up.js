export function preInitPopUpForm() {
    ...
    (function() {
      ...
      var _removed = false;
      var form_to_submit = document.getElementById('_form_145_');
      ...
      var form_submit = function(e) {
        ...
        if (validate_form()) {
          ...
          document.querySelector('#_form_145_submit').disabled = true;
                var serialized = _form_serialize(document.getElementById('_form_145_')).replace(/%0A/g, '\\n');
